...
- Zpracovat seznam emocí - done

## Emoce - [převzato z wikipedie](https://cs.wikipedia.org/wiki/Emoce)

### Rozdělení emocí podle charakteru

Emoce lze podle jejich evolučního stáří rozdělit na základní a vyšší. Základní emoce se vyskytují nejen u všech národností a kultur, ale z velké části i u vyšších živočichů. Související jednání a mimika jsou zčásti vrozené (smích, pláč). Přesné vymezení základních emocí se u různých autorů liší. [[27]](https://cs.wikipedia.org/wiki/Emoce#cite_note-Vondr%C3%A1%C4%8Dek-27)[[32]](https://cs.wikipedia.org/wiki/Emoce#cite_note-32)[[33]](https://cs.wikipedia.org/wiki/Emoce#cite_note-33)

#### Základní emoce

| **emoce** | podnět | reakce |
|---|---|---|
| *[strach](https://cs.wikipedia.org/wiki/Strach "Strach")* | nebezpečí | útěk (únik), boj, strnutí |
| *[hněv](https://cs.wikipedia.org/wiki/Hn%C4%9Bv "Hněv")* | překážka, nepřítel | útok, agrese |
| *[radost](https://cs.wikipedia.org/wiki/Radost "Radost")* | zisk, úspěch | uvolnění, úsměv |
| *[smutek](https://cs.wikipedia.org/wiki/Smutek "Smutek")* | ztráta hodnoty, neúspěch | pláč, apatie |
| *[důvěra](https://cs.wikipedia.org/wiki/D%C5%AFv%C4%9Bra "Důvěra")* | přátelství, přímé jednání | spolehnutí se na druhého |
| *[znechucení](https://cs.wikipedia.org/wiki/Hnus "Hnus")* | nepříjemná věc nebo situace | odstranění zdroje znechucení, únik |
| *[očekávání](https://cs.wikipedia.org/wiki/O%C4%8Dek%C3%A1v%C3%A1n%C3%AD "Očekávání")* | neznámá, nejistá situace | orientace, získávání informací |
| *[překvapení](https://cs.wikipedia.org/wiki/P%C5%99ekvapen%C3%AD "Překvapení")* | nečekaná situace | nástup další emoce podle situace (strach, radost, očekávání aj.) |

#### Vyšší emoce

-   *intelektuální* -- zaměřené na překonávání překážek a problémů:
    -   cit pro [pravdu](https://cs.wikipedia.org/wiki/Pravda "Pravda") a hodnotu pravdy
    -   [zvědavost](https://cs.wikipedia.org/w/index.php?title=Zv%C4%9Bdavost&action=edit&redlink=1 "Zvědavost (stránka neexistuje)")
    -   [frustrace](https://cs.wikipedia.org/wiki/Frustrace "Frustrace") z [nepochopení](https://cs.wikipedia.org/w/index.php?title=Nepochopen%C3%AD&action=edit&redlink=1 "Nepochopení (stránka neexistuje)")
-   *morální* -- vystupují ve vztahu k [morálce](https://cs.wikipedia.org/wiki/Mor%C3%A1lka "Morálka") společnosti:
    -   [stud](https://cs.wikipedia.org/wiki/Stud "Stud")
    -   [altruismus](https://cs.wikipedia.org/wiki/Altruismus "Altruismus")
    -   [empatie](https://cs.wikipedia.org/wiki/Empatie "Empatie")
-   *estetické* -- hodnotí a vyjadřují [vkus](https://cs.wikipedia.org/wiki/Vkus "Vkus") člověka

### Citové vztahy

Kombinací určitých emocí se vytvářejí složitější vazby na ostatní jedince, které nazýváme citové vztahy. Jsou to především:

-   [láska](https://cs.wikipedia.org/wiki/L%C3%A1ska "Láska")
-   [přátelství](https://cs.wikipedia.org/wiki/P%C5%99%C3%A1telstv%C3%AD "Přátelství")
-   [nenávist](https://cs.wikipedia.org/wiki/Nen%C3%A1vist "Nenávist")
-   [nepřátelství](https://cs.wikipedia.org/w/index.php?title=Nep%C5%99%C3%A1telstv%C3%AD&action=edit&redlink=1 "Nepřátelství (stránka neexistuje)")
-   [závist](https://cs.wikipedia.org/wiki/Z%C3%A1vist "Závist")
-   [žárlivost](https://cs.wikipedia.org/wiki/%C5%BD%C3%A1rlivost "Žárlivost")
-   [pohrdání](https://cs.wikipedia.org/wiki/Pohrd%C3%A1n%C3%AD "Pohrdání") a [opovržení](https://cs.wikipedia.org/w/index.php?title=Opovr%C5%BEen%C3%AD&action=edit&redlink=1 "Opovržení (stránka neexistuje)")
-   [odpor](https://cs.wikipedia.org/w/index.php?title=Odpor_(psychologie)&action=edit&redlink=1 "Odpor (psychologie) (stránka neexistuje)") a [štítivost](https://cs.wikipedia.org/w/index.php?title=%C5%A0t%C3%ADtivost&action=edit&redlink=1 "Štítivost (stránka neexistuje)")
...
-   [bolest](https://cs.wikipedia.org/wiki/Bolest "Bolest")
-   [únava](https://cs.wikipedia.org/wiki/%C3%9Anava "Únava")
-   [hlad](https://cs.wikipedia.org/wiki/Hlad "Hlad")
